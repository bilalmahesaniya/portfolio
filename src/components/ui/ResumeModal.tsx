        ...
        <div className="flex items-start justify-between border-b border-border-subtle pb-5">
          <div className="space-y-1">
            ...
            <p className="text-xs font-mono text-accent-primary">
              UI/UX Designer • 1 Year Experience @ Xipra Tech • Computer Science
            </p>
          </div>
        ...
        <div className="space-y-8 font-sans">
          ...
          <div className="p-5 rounded-xl bg-bg-surface-alt border border-border-subtle space-y-2">
            ...
            <p className="text-sm text-text-secondary leading-relaxed">
              Design professional bridging computer science principles with human-first UI/UX.
              1 year of commercial experience at Xipra Tech delivering component design systems,
              interactive prototypes in Figma, responsive web/mobile interfaces, and WCAG 2.1 AA accessibility.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs font-mono">
            <div className="p-5 rounded-xl bg-bg-surface-alt border border-border-subtle space-y-3">
              ...
              <div className="space-y-2 font-sans">
                <div>
                  <p className="font-medium text-text-primary">Computer Science</p>
            ...
            <div className="p-5 rounded-xl bg-bg-surface-alt border border-border-subtle space-y-3">
              ...
              <div className="space-y-2 font-sans">
                <div>
                  <p className="font-medium text-text-primary">UI/UX Designer (1 Year Experience)</p>
                  <p className="text-xs text-text-secondary">Xipra Tech • 2023 – 2024</p>
                </div>
                <div className="pt-1">
